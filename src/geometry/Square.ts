...
class Square extends Drawable {
  ...
  this.positions = new Float32Array([-0.5, 0, 0, 1,
    ...
    this.generateInstanceIdx();
    this.generateScaleFactor();
  ...
  setInstanceVBOs(offsets: Float32Array, colors: Float32Array, instanceIdx: Float32Array, scaleFactors: Float32Array) {
    this.colors = colors;
    ...
    gl.bufferData(gl.ARRAY_BUFFER, this.instanceIdx, gl.STATIC_DRAW);
    gl.bindBuffer(gl.ARRAY_BUFFER, this.bufScaleFactor);
    gl.bufferData(gl.ARRAY_BUFFER, this.scaleFactors, gl.STATIC_DRAW);
  }
};
